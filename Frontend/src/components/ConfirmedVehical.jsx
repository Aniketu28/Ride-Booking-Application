...
const ConfirmedVehical = ({ confirmData , confirmRidePannel, setConfirmRidePannel, setVehicalPannel , setLookingDriver}) => {
    return (
        <div className='pb-3'>
            <div className='flex justify-between items-center mb-4'>
                <h4 className='text-2xl font-semibold text-black ms-1'>Confirm Your Ride</h4>
                {confirmRidePannel && <svg xmlns="http://www.w3.org/2000/svg" onClick={() => {
                    setConfirmRidePannel(false)
                    setVehicalPannel(true);
                }} width="30" height="30" viewBox="0 0 24 24" fill="#000"><path d="M11.9999 13.1714L16.9497 8.22168L18.3639 9.63589L11.9999 15.9999L5.63599 9.63589L7.0502 8.22168L11.9999 13.1714Z"></path></svg>}
            </div>
            <div className='flex flex-col justify-center items-center gap-3'>
                <div>
                    <img className='w-full h-[100px]' src="https://t4.ftcdn.net/jpg/04/21/54/81/360_F_421548121_XaPCh9ktAo6eRXROsLvGkq1a3djbFVYd.jpg" alt="confirm ride image" />
                </div>
                <div className='w-full flex flex-col justify-center items-start gap-4'>
                    <div className='w-full flex justify-strat items-start gap-4 border-b-2 py-2'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-600 text-base'>{confirmData.pickup}</p>
                        </div>
                    </div>
                    <div className='w-full flex justify-strat items-start gap-4 border-b-2 py-2'>
                        <div>
                        ...
                        <div>
                            ...
                            <p className='text-gray-600 text-base'>{confirmData.destination}</p>
                        </div>
                    </div>
                    <div className='w-full flex justify-strat items-start gap-4'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium leading-5'>{confirmData.fare}</h3>
                            <p className='text-gray-600 text-base'>Cash</p>
                        </div>
                    </div>
                </div>
                <div className='w-full'>
                    <button onClick={()=>{setLookingDriver(true)
                        setConfirmRidePannel(false)
                    }} className='w-full bg-green-600 text-white font-semibold rounded-lg px-3 py-3'>Confirm</button>
                </div>
            </div>
...
export default ConfirmedVehical
