...
const RidePopUp = ({ setRidePopUpPannel, setconfrimRidePopUpPannel, ride , confirmRide}) => {
    
    return (
        <div className='py-3 px-3'>
            <div className='flex justify-start items-center mt-3 mb-4'>
                <h4 className='text-2xl font-semibold text-black ms-1'>New Ride Available</h4>
            </div>
            <div className='w-full bg-yellow-500 py-4 px-3 flex justify-between items-center mt-4 mb-3'>
            ...
            <div className='flex flex-col justify-center items-center gap-3 mt-5'>
                <div className='w-full flex flex-col justify-center items-start gap-4'>
                    <div className='w-full flex justify-strat items-start gap-4 border-b-2 py-2'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-600 text-base'>{ride?.pickup ? ride?.pickup : "no data "}</p>
                        </div>
                    </div>
                    <div className='w-full flex justify-strat items-start gap-4 border-b-2 py-2'>
                        <div>
                        ...
                        <div>
                            ...
                            <p className='text-gray-600 text-base'>{ride?.destination ? ride?.destination : "no data"}</p>
                        </div>
                    </div>
                    <div className='w-full flex justify-strat items-start gap-4'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium leading-5'>₹{ride?.fare ? ride?.fare : "no data"}</h3>
                ...
                <div className='w-full flex justify-between items-center gap-2 mt-1'>
                    <button onClick={() => {
                        confirmRide()
                    }} className='w-1/2 bg-green-600 text-white font-semibold rounded-lg px-3 py-3'>Accept</button>
                    <button onClick={() => { setRidePopUpPannel(false) }} className='w-1/2 bg-gray-500 text-white font-semibold rounded-lg px-3 py-3'>Ignore</button>
